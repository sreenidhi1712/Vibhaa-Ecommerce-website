  ...
  return (
    <>
      <div className={`h-screen w-auto ${Toggle ? 'bg-white' : 'bg-gray-900'}`} onClick={() => {
        ...
        <div className="w-full h-2/3 bg-gradient-text flex flex-col bg-[url('https://images.pexels.com/photos/1557843/pexels-photo-1557843.jpeg?auto=compress&cs=tinysrgb&w=600')] bg-cover bg-center">
          {/* First Card */}
          <div className="flex flex-col h-[58%] w-full ">
            <p className="text-3xl text-white text-center mt-16 font-extrabold">Raining Offers for this Monsoon!</p>
            <p className="text-2xl text-white mt-5 text-center font-bold">25% OFF On All Products</p>
          </div>
        ...
        <div className="w-full h-auto flex flex-col items-center">
          <div className="w-[90%] h-56 bg-slate-500 flex flex-col items-center bg-[url('https://images.pexels.com/photos/1267369/pexels-photo-1267369.jpeg?auto=compress&cs=tinysrgb&w=600')] bg-cover bg-center">
            ...
            <button className="mt-3 h-10 w-5/6 bg-white font-semibold">SHOP NOW</button>
          </div>
          <div className="w-[90%] h-56 bg-slate-500 mt-5 flex flex-col items-center bg-[url('https://images.pexels.com/photos/375880/pexels-photo-375880.jpeg?auto=compress&cs=tinysrgb&w=600')] bg-cover bg-center">
            <div className="h-2/3 w-full flex flex-col justify-end">
          ...
          <div className="w-[90%] h-56 bg-slate-500 mt-5 flex flex-col items-center bg-[url('https://images.pexels.com/photos/1496647/pexels-photo-1496647.jpeg?auto=compress&cs=tinysrgb&w=600')] bg-cover bg-center">
            <div className="h-2/3 w-full flex flex-col justify-end">
              <p className="pl-2 font-bold text-white">20% Off on Tank Tops</p>
              <p className="pl-2 font-bold text-white">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Placeat, necessitatibus!</p>
            </div>
          ...
          <div className="mt-10 flex w-full flex-wrap flex-shrink-0 justify-between">
            ...
            <div className="flex flex-col w-[45%] h-52 mx-2 my-2 bg-white">
              <div className="h-[55%] bg-slate-600">
                <img src="https://images.pexels.com/photos/2529148/pexels-photo-2529148.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" className="h-full w-full object-cover"/>
              </div>
              <div>
        ...
        <div className="mt-14 w-[90%] h-[65%] bg-gradient-text flex flex-col mx-auto bg-[url('https://images.pexels.com/photos/2036646/pexels-photo-2036646.jpeg?auto=compress&cs=tinysrgb&w=600')] bg-cover  bg-center">
          <div className="flex flex-col h-[78%] w-full">
            <p className="text-2xl text-white text-center mt-10 font-bold">Limited Time Offer</p>
            <p className="text-2xl text-white mt-2 text-center font-bold">Special Edition</p>
            <p className="text-white mt-2 text-justify px-7 font-bold">Lorem ipsum dolor sit, amet consectetur adipisicing elit. In, incidunt!</p>
            <p className="text-xl text-white mt-2 text-justify mx-4 font-bold">Buy This T-shirt At 20% Discount, Use Code OFF20</p>
          </div>
